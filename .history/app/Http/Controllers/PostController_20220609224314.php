...
class PostController extends Controller
{
    ...
    public  function store(Request $request)
    {
        ...
        session()->flash('message', 'Merci de vous être inscrit(e) en tant que donneur sur la platforme savelifes. Vous recevrez tous nos prochains alertes par  en cas de besoin de sang.');
