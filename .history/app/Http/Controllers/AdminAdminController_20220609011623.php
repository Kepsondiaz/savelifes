                ...
                $msg->save();
                 ...
                 foreach($alertes as $alerte)
                 {
                     //notification par message
                          $sms->message('Bonjour, Mr/Mme nous avons besoin d\'un sang de type '.strtoupper($request->groupe_sanguin).' lieu '.strtou$request->hopital.' niveau d\'urgence: '.$request->niveau_urgence)
                          ->from('+221775530932')
