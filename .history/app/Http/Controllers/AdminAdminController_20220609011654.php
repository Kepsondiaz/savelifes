                ...
                $msg->save();
                 ...
                 foreach($alertes as $alerte)
                 {
                     //notification par message
                          $sms->message('Bonjour, Mr/Mme nous avons besoin d\'un sang de type '.strtoupper($request->groupe_sanguin).' lieu '.strtoupper($request->hopital).' niveau d\'urgence: '.strrtoupper($request->niveau_urgence))
                          ->from('+221775530932')
