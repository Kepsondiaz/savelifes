        ...
        <div>
            ...
            <hr class="trait">
                <form action="welcome" method="POST">
                    ...
                    <input type="radio" name="sexe" id="masculin" value="M"> Masculin
                    <label id="sexe" for="feminin"></label>
                    <input type="radio" name="sexe" id="feminin" value="F"> Feminin
                    ...
                    <input type="email" id="email" name="email" class="largeur" placeholder="Ex: nom@gmail.com" re>
