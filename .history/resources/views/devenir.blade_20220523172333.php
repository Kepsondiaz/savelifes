    ...
    <body>
        ...
        <div class="bouki">
            <div>
                ...
                <hr class="trait">
                    <form action="devenir" method="POST">
                        <label id="reponse">Avez-vous fait une fois un don ?</label>
                        <input type="radio" name="reponse" id="oui"> Oui
                        <input type="radio" name="reponse" id="non"> Non
                        ...
                        <input type="text" id="telephone" name="telephone" placeholder="Votre numéro de Téléphone" class="largeur" required>
                        <span  id="error2"></span><br>
    
                        <label for="date_naissance">Date de naissance</label>
                        <input type="date" id="date_naissance" name="date_naissance" class="largeur" required>
                        ...
                        <input type="text" id="adresse" name="adresse" placeholder="Votre adresse" class="largeur" required>
